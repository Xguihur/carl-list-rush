...
---
## 翻转字符串里的单词
> （卡哥想要不使用额外空间完成这个算法，就选择了将字符串翻转后再翻转每个单词，比较有技巧性，有意思。难点是 多余空格的处理，也不算难点，就是一个细节）

> 笔试中遇到可以使用 split 分割单词，再将这些单词倒叙插入新的数组中去即可，甚至就分割开的这个单词数组，翻转一下就好了
